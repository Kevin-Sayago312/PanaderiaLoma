 ...
 */
final class Version20240606173724 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE carritos (id INT AUTO_INCREMENT NOT NULL, productos_id INT DEFAULT NULL, cantidad INT NOT NULL, subtotal INT NOT NULL, INDEX IDX_EDC00FEEED07566B (productos_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE carritos ADD CONSTRAINT FK_EDC00FEEED07566B FOREIGN KEY (productos_id) REFERENCES productos (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE carritos DROP FOREIGN KEY FK_EDC00FEEED07566B');
        $this->addSql('DROP TABLE carritos');
        $this->addSql('ALTER TABLE categorias CHANGE categoria categoria VARCHAR(255) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE messenger_messages CHANGE delivered_at delivered_at DATETIME DEFAULT \'NULL\' COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('ALTER TABLE productos CHANGE nombre nombre VARCHAR(255) DEFAULT \'NULL\', CHANGE descripcion descripcion VARCHAR(255) DEFAULT \'NULL\', CHANGE precio precio DOUBLE PRECISION DEFAULT \'NULL\', CHANGE photo photo VARCHAR(255) DEFAULT \'NULL\'');
